...
public class FileController {
	...
	public UploadFileResponseVO uploadFile(@RequestParam("file") MultipartFile file) {
		...
		System.out.println(">>>>>>> .path(api file..) "
				+ ServletUriComponentsBuilder.fromCurrentContextPath().path("/api/file/v1/downloadFile/"));
		System.out.println(">>>>>>> .path(fileName) " + ServletUriComponentsBuilder.fromCurrentContextPath()
				.path("/api/file/v1/downloadFile/").path(fileName));
		System.out.println(">>>>>>> .toUriString(); " + ServletUriComponentsBuilder.fromCurrentContextPath()
